...
// Non edited musical note transfert query
// 19/05/2015, 15 655 insert on 15 655 non edited musical note from the raddo database

$sql = "insert into ethnodoc.noneditedmusicalnote (id, title, locality, url, leadInCoupletFR, leadInRefrainFR, leadInCoupletVO,
        leadInRefrainVO, authorAncient, traditionalAuthor, publisherAncient, traditionalPublisher, culture, language,
        coiraultTheme, coiraultNumber, laforteNumber, precotationEthnodoc, survey)
        ...
        raddo.c_titre_off.titre_coirault, raddo.c_titre_off.cote_coirault, raddo.c_titre_off.titre_laforte, raddo.c_titre_off.cote_ethnodoc,
        ...
        LEFT JOIN c_cd ON document_son.cle_cd = c_cd.cle_cd)
